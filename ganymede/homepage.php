...
<div class="form-group"><label for="Phone_Number">Phone number </label><br>
<input id="Phone_Number" type="text" class="form-control" name="Phone_Number"></div>
...
<div class="col-md-4 px-3 ">
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <li class="microsite-name"><a class="nav-link" href="#">Ganymede Microsite <span style="text-transform: none;"></span></a></li>
      <li class="nav-item "><a class="nav-link expandable collapsed" href="#sectionOne" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sectionOne">Section One a.expandable </a>
      <div id="sectionOne" aria-labelledby="" class="collapse" style="">
  <div class="card card-body">
          <a class="" href="#">A Subsection</a>
          <a class="" href="#">Another Subsection</a>
        </div>
        </div>
        </li>
      <li class="nav-item"><a class="nav-link" href="#">Section Two</a></li>
      <li class="nav-item"><a class="nav-link" href="#">Section Three</a></li>
    </ul>
  </nav>
    </div>
